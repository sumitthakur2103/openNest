  ...
  return (
    <div ref={ctnDom} className="aurora-container">
      <div className="aurora-content">
        <h2>Discover Your Perfect Stay Today!</h2>
        <p>
          Experience vibrant accommodations tailored for every budget. Whether
          you're traveling solo or with friends, we have the ideal space just
          for you!
        </p>
